...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--epochs', type=int, default=500000, help="rounds of training")
    parser.add_argument('--num_users', type=int, default=78, help="number of users: K")
    ...
    parser.add_argument("--algorithm", type=str, default="CaBaFL")
    parser.add_argument("--limit_time", type=int, default=500000)
    ...
    # other arguments
    parser.add_argument('--dataset', type=str, default='ShakeSpare', help="name of dataset")
    ...
    # FedASync
    parser.add_argument('--FedASync_alpha', type=float, default=0.6, help='The hypter parameter for the FedASync')
    ...
    parser.add_argument('--CF', type=int, default=50)
    parser.add_argument('--CB', type=float, default=0.75)
